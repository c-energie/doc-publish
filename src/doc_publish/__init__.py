"""doc-publish: turn a LaTeX document into a queryable corpus, a Notion wiki and a site.
...
Every path comes from `doc_publish.config`, so the entry points run from any directory.
"""
