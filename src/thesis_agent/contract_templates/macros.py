...
See `thesis_agent/ingest/adapter.py` for the contract. In short: pure text -> text,
...
# `thesis-agent check` flags any macro this document defines that is not mentioned
